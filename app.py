...
def users_likes(user_id):
    """Show a list of messages the logged-in user has liked."""
...
def profile():
    ...
    if form.validate_on_submit():
        ...
        user = User.check_password(form.email.data, form.password.data)
        ...
        if user:
            ...
            flash(f"Password is incorrect for {{current_user.username}}", "danger")
...
def add_like(message_id):
    """Add/delete a 'Like' for a message"""
